...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_name', models.CharField(choices=[('EN', 'English')], default='EN', max_length=32)),
                ('resource_name', models.CharField(choices=[('transliteration', 'Transliteration')], default='transliteration', max_length=32)),
